...
ifneq "$(KERNELVERSION)" "5.6.5"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "aarch64-linux-android-gcc (UBERTC-4.9.4) 4.9.4 20160401 (optimized)"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/home/ark/develop/g950f/aarch64-linux-android-4.9-kernel/bin/aarch64-linux-android-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/home/ark/develop/g950f/aarch64-linux-android-4.9-kernel/bin/aarch64-linux-android-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "/home/ark/develop/g950f/aarch64-linux-android-4.9-kernel/bin/aarch64-linux-android-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/home/ark/develop/g950f/aarch64-linux-android-4.9-kernel/bin/aarch64-linux-android-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
